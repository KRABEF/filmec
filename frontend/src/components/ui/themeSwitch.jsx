  ...
  return (
    <div className="flex items-center gap-3 select-none w-full">
      <button
        ...
        className="relative w-15 h-9 rounded-full bg-neutral-800 dark:bg-neutral-700 shadow-inner overflow-hidden transition-colors duration-500"
      >
        <div
        ...
        <div
          className={`absolute top-1 w-6.5 h-6.5 rounded-full flex items-center justify-center shadow-lg transition-all [&_svg]:p-0.2 duration-500 ease-in-out ${
