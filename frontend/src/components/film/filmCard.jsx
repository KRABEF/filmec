      ...
      <div className="flex-shrink-0 mx-auto lg:mx-0 ">
        ...
        <div className="flex gap-1 mt-2">
          ...
          <button
            ...
            className="flex items-center justify-center shadow-sm  dark:bg-neutral-800/80 light:border border-neutral-300 bg-neutral-200 rounded-xl p-4 min-w-[80px] hover:bg-neutral-300/80 hover:dark:bg-neutral-700/50 group"
          >
            <div className="text-center">
              {isSaved ? (
                ...
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-bookmark dark:text-neutral-400 text-neutral-700 group-hover:text-orange-400"
                  viewBox="0 0 16 16"
                >
      ...
      <div className="flex-grow">
        <div className="flex flex-col lg:flex-row lg:items-start justify-between">
          ...
          <div className="flex gap-3 justify-center my-2 lg:m-0">
            <div className="flex items-center justify-center gap-3 dark:bg-neutral-800/50 bg-neutral-200/70 rounded-xl p-4 min-w-[80px] shadow-sm">
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-500">{film.rating}</div>
                <div className="text-xs text-neutral-500">IMDb</div>
              </div>
            </div>
          </div>
        </div>
