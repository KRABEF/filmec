              ...
              <div className="flex flex-col items-center cursor-pointer">
                <div className="relative">
                  {actor.photo ? (
                    ...
                    <div className="w-40 h-40 rounded-full dark:bg-neutral-600 bg-neutral-400/70 flex items-center justify-center dark:text-neutral-200 text-3xl">
                      {actor.name[0]}
                    </div>
                  )}
                </div>
...
const ArrowButton = ({ children, onClick, direction }) => {
  return (
    <button
      onClick={onClick}
      className={`active:scale-95 p-3 rounded-full dark:bg-neutral-900/70 bg-neutral-300 hover:bg-neutral-400/50 dark:hover:bg-neutral-900 dark:text-neutral-300 text-neutral-900 dark:shadow-lg absolute top-1/2 transform -translate-y-1/2 z-10 ${
